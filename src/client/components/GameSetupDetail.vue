        ...
        <div id="game-setup-detail" class="game-setup-detail-container">
          <ul>
            <li><div class="setup-item" v-i18n>Expansion:</div>
              ...
              <a v-if="gameOptions.expansions.tournament" :href="rulebookUrls.tournament" class="tooltip" data-tooltip="Tournament rules" target="_blank"><div class="create-game-expansion-icon expansion-icon-tournament"></div></a>
            </li>
            ...
            <li><div class="setup-item" v-i18n>Game configs:</div>
              ...
              <div v-if="gameOptions.playerPasswords" class="game-config" v-i18n>player passwords</div>
            </li>
