export enum CardName {
  ...
  AUTOMA_LOBBYISTS_VENUS = 'Automa: Lobbyists (Venus)',
  AUTOMA_GOVERNMENT_INTERVENTION = 'Automa: Government Intervention',
  AUTOMA_EXPEDITED_CONSTRUCTION_COLONIES = 'Automa: Expedited Construction (Colonies)',
  AUTOMA_OUTER_SYSTEM_FOOTHOLD = 'Automa: Outer System Foothold',
  AUTOMA_SHIPPING_LINES = 'Automa: Shipping Lines',
  AUTOMA_EXTENDED_SHIPPING_LINES = 'Automa: Extended Shipping Lines',
  AUTOMA_PARTY_POLITICS = 'Automa: Party Politics',
  AUTOMA_SETTLERS = 'Automa: Settlers',
  AUTOMA_RAPID_SPROUTING = 'Automa: Rapid Sprouting',
  AUTOMA_SUPPLY_AND_DEMAND = 'Automa: Supply & Demand',
  AUTOMA_DO_IT_RIGHT = 'Automa: Do It Right',
  AUTOMA_VENUSIAN_LOBBY = 'Automa: Venusian Lobby',
  AUTOMA_BUILD_BUILD_BUILD = 'Automa: Build, Build, Build',
  AUTOMA_DIVERSIFICATION = 'Automa: Diversification',
  AUTOMA_GRAY_EMINENCE = 'Automa: Gray Eminence',
  AUTOMA_INTERFACE_HYPERLINK = 'Automa: Interface Hyperlink',
  AUTOMA_GOVERNMENT_SUBSIDY = 'Automa: Government Subsidy',
  AUTOMA_INVESTORS = 'Automa: Investors',
