...
export interface IGame extends Logger {
   ...
   * a tile on The Moon.
   */
  addTile(player: IPlayer, space: Space, tile: Tile, options?: {grantSpaceBonuses?: boolean}): void;
  /**
  ...
  addGreenery(player: IPlayer, space: Space, shouldRaiseOxygen?: boolean, options?: {grantSpaceBonuses?: boolean}): void;
  addCity(player: IPlayer, space: Space, cardName?: CardName | undefined, options?: {grantSpaceBonuses?: boolean}): void;
  canAddOcean(): boolean;
  canRemoveOcean(): boolean;
  addOcean(player: IPlayer, space: Space, options?: {grantSpaceBonuses?: boolean}): void;
