...
export const MILESTONE_EVALS = new Map<MilestoneName, MilestoneEval>([
  ...
  ['Tactician', (bot) => bot.megacredits >= 35],
...
export const AWARD_EVALS = new Map<AwardName, AwardEval>([
  ...
  ['Excentric', (bot) => Math.floor(bot.megacredits / 5)],
  ...
  ['Forecaster', (bot) => Math.floor(bot.megacredits / 7)],
  // Utopia Planitia
  ['Suburbian', () => undefined],
