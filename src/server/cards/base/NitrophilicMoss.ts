...
export class NitrophilicMoss extends Card implements IProjectCard {
  ...
  public override bespokeCanPlay(player: IPlayer): boolean {
    ...
    const hasEnoughPlants = player.plants >= 2 || player.tableau.has(CardName.MANUTECH) || player.tableau.has(CardName.MANUTECH_TOURNAMENT) || player.plants >= 1 && viralEnhancers !== undefined;
