...
export type RouteErrorKind = 'badRequest' | 'contentTooLarge' | 'forbidden' | 'internalServerError' | 'notFound' | 'unauthorized';
...
export class RouteError extends Error {
  ...
  public static unauthorized(message?: string): RouteError {
    return new RouteError('unauthorized', message);
  }
}
